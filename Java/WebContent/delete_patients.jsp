...
<body>
	<center>
		...
		<h3 align="center">Delete Patients Who Were Discharged Before A Particular Year</h3>
		<h3 align="center">
			<jsp:useBean id="empsbean" class="cs5513.DataHandler" scope="session" />
		</h3>

		<form action="delete_patients_action.jsp">
			<div align="center">
				<p>&nbsp;</p>
				<table cellspacing="2" cellpadding="3" border="1" width="369">
					<tr>
						<td width="45%"><strong>discharged year:</strong></td>
						<td width="62%"><input type="text" name="discharged year" /></td>
					</tr>
				</table>
